...
declare const makeWASocket: (config: UserFacingSocketConfig) => {
    ...
    sendCarouselWithLimitOffer: (jid: string, options?: any) => Promise<import("../index.js").WAMessage>;
    Button: () => MessageBuilder.Message;
    ButtonV2: () => MessageBuilder.Message;
    Carousel: () => MessageBuilder.Carousel;
    AIRich: () => MessageBuilder.Message;
