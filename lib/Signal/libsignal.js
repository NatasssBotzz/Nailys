import { ProtocolAddress, SessionCipher, SessionRecord, SessionBuilder, PreKeyWhisperMessage } from './libsignal-bridge.js';
...
function signalStorage({ creds, keys }, lidMapping) {
    ...
    return {
        ...
        removePreKey: async (id) => { await keys.set({ 'pre-key': { [id]: null } }); },
        loadSignedPreKey: () => {
