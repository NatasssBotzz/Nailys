...
export const makeNewsletterSocket = (config: SocketConfig) => {
	...
	const newsletterMetadata = async (type: 'invite' | 'jid', key: string) => {
		const variables = {
	...
	return {
		...
		newsletterUpdateMetadata: async (jid: string, updates: NewsletterUpdate) => {
			return await newsletterUpdate(jid, updates)
		},

		newsletterMetadataByJid: async (jid: string) => {
			return await newsletterMetadata('jid', jid)
		},

		newsletterMetadataByInvite: async (invite: string) => {
			return await newsletterMetadata('invite', invite)
		},
